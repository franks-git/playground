...
import static com.kaswiner.gamelet1.Window.HEIGHT;
import static com.kaswiner.gamelet1.Window.WIDTH;
...
public class Map1 {
    ...
    public Map1() {
        ...
        try {
            this.imageBackgroundMap = ImageIO.read(new File("src/img/grass_template2.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
